...
## That's better. but one value is much larger than the others
...
### Which users are tweeting about this the most?
#### What languages are they tweeting in?
```{r user id}
freq_user <- data %>%
...
## most individuals are only tweeting once or twice
...
## A lot of these hashtags are just harry or meghan. let's remove those to get a better sense of the other topics connected to the interview
...
## let's do this for the remainder of these analyses
...
### let's combine these datasets to create a graph showing the change in the orportion of tweets using these hashtags across time
```{r hashtags prop across days}
